...
bool AudioExtension::OnPluginLoad(std::string pluginName, void *pluginState, PluginKind_t kind, std::string &error)
{
  ...
  luabridge::getGlobalNamespace(state)
      ...
      .addFunction("PlayToPlayerFromBuffer", &Audio::PlayToPlayerFromBuffer)
      .addFunction("PlayToPlayerFromFile", &Audio::PlayToPlayerFromFile)
      .addFunction("PlayFromBuffer", &Audio::PlayFromBuffer)
      .addFunction("PlayFromFile", &Audio::PlayFromFile)
